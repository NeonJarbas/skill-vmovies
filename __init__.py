...
class VMoviesSkill(OVOSCommonPlaybackSkill):
    def __init__(self):
        super().__init__("VMovies")
        self.supported_media = [MediaType.MOVIE,
                                MediaType.GENERIC]
        self.skill_icon = self.default_bg = join(dirname(__file__), "ui", "vmovies_icon.jpg")
        self.archive = YoutubeMonitor(db_name="VMovies",
                                      min_duration=30 * 60,
                                      logger=LOG,
    ...
    def initialize(self):
        url = "https://www.youtube.com/channel/UCPPPrnT5080hPMxK1N4QSjA"
        bootstrap = "https://raw.githubusercontent.com/OpenJarbas/streamindex/main/VMovies.json"
    ...
    def search_db(self, phrase, media_type):
        ...
        if self.voc_match(phrase, "vmovies"):
